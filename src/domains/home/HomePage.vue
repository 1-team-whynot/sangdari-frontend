...
import { howItWorks, stepIconPaths } from './constants/howItWorks.js'
...
const normalizeStore = (store) => {
  ...
  return {
    ...
    status: batterySupported ? '전기 불필요' : '전기 필요',
    imageUrl: getStoreImageUrl(store.imageUrl),
            ...
            >
              <div class="step-icon" aria-hidden="true">
                <svg viewBox="0 0 24 24" focusable="false">
                  <path
                    v-for="iconPath in stepIconPaths[item.icon]"
                    :key="iconPath"
                    :d="iconPath"
                  />
                </svg>
